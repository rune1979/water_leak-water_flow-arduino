// BEWARE this is a shortened version of Adafruits BluefruitLE nRF51 library. Get the full version in the library manager. 
// you may need to do some aditional implementation depending on you model and producer 
